...
const notify_tgb = async () =>
{
    ...
    const owner_obj =
    {
        ...
        "152.53.228.201": "Digger",
        "188.132.232.192": "Digger2",
        "85.209.195.170": "Digger3",
        "152.53.124.246": "Digger4",
        "89.58.54.193": "Digger5",
        "91.107.178.76": "Taban",
        "116.203.54.79": "Amir",
        "138.124.127.32": "Reza",
        "188.245.166.164": "Test_Sina",
        "168.119.107.139": "jahanbani",
        "5.75.198.190": "AmirNew",
    }
    ...
    await axios.post(`https://api.telegram.org/bot6552201638:AAEas5y5MV1x-npjMWPJsN06BNzxwSukhAc/sendMessage`, 
    {
        chat_id:95945429,
        text: "🔹 IRT Server instance started" + " \\( PORT " + process.env.SERVER_PORT + " \\)" + "\n" + owner_string + "\n\n" + "```\n" + server_ip + "\n```",
